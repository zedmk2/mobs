...
class PropertyAdmin(admin.ModelAdmin):
    search_fields = ['name']
    list_display = ['name','display_name','address','check_priority','sw_price','sw_mo_price','times_per_week','times_per_month','times_per_year']
    list_editable = ['display_name','check_priority','sw_price','sw_mo_price','times_per_month','times_per_week','times_per_year',]
